...
# Comparacion (Boolean)
print(numero1 == numero2) # igual que
print(numero1 != numero2) # diferente que
print(numero1 > numero2) # mayor que
print(numero1 < numero2) # menos que
...
print(not numero1 > numero2) # invierte el resultado de la comparacion
